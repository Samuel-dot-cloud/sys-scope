...
extension DiskUtility {
    public static func getDeviceIOParent(_ obj: io_registry_entry_t, level: Int) -> io_registry_entry_t? {
    ...
    public static func getIOProperties(_ entry: io_registry_entry_t) -> NSDictionary? {
